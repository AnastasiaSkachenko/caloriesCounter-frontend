...
export const descriptions: Record<ActivityType, Record<number, string>> = {
  ...
  "work_bk": {
    1: "Light duties at Burger King, such as cleaning tables, restocking condiments, or light prep work.",
    2: "Moderate tasks, including taking orders, preparing simple items, or moderate cleaning.",
    3: "Standard pace work, like cooking at the grill, assembling burgers, and working at the register during normal hours.",
    4: "High-paced shifts during rush hours, multitasking between food prep, register work, and cleaning.",
    5: "Maximum intensity shift, constant movement during peak times, handling multiple orders, and heavy lifting."
  }
};
