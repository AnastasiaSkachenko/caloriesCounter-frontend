...
const Dishes: React.FC = () => {
  ...
  const [dishName, setDishName] = useState<string | null>()
                      ...
                      <li key={index} className="bg-light border rounded m-2 p-4">
                        ...
                        {dishName == dish.name ? (
                            <div>
                              ...
                              <button onClick={() => setDishName(null)} >Cancel</button>
                            </div>
                        ) : (
                            <button onClick={() => setDishName(dish.name)}>Edit Dish Name</button>
                        )}
                        {dish.type == 'own' && (
                          <div>
                            <h4>Ingredients:</h4>
